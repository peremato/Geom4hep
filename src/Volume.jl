...
struct Volume{T<:AbstractFloat}
    ...
    material::AbstractMaterial         # Reference to material
...
function Volume(label::String, shape::Geom4hep.AbstractShape{T}, material::AbstractMaterial) where T<:AbstractFloat
